...
create or replace function public.qlcl_approve_plan_bundle_v9(
  p_program_id uuid,
...
begin
  ...
  values(
    p_actor_user_id,v_record.id,'work_programs',p_program_id,'APPROVE_PLAN_BUNDLE_V9',
    jsonb_build_object(
      'program_id',p_program_id,
...
revoke all on function public.qlcl_approve_plan_bundle_v9(uuid,uuid) from public, anon, authenticated;
grant execute on function public.qlcl_approve_plan_bundle_v9(uuid,uuid) to service_role;
