alter table public.recurring_work_templates
  add column if not exists automation_target_area text;
...
begin
  ...
  values(
    p_actor_user_id,v_action_record_id,'recurring_work_runs',v_run.id,'MATERIALIZE_RECURRING_RUN_V2',
  ...
  return jsonb_build_object(
    ...
    'output_record_id',v_output_record_id,'monitoring_round_id',v_monitoring_round_id
  );
end;
$function$;
