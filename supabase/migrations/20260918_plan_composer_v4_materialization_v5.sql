...
create or replace function public.qlcl_approve_plan_bundle_v5(
  p_program_id uuid,
...
begin
  ...
  loop
    ...
    insert into public.actions(
      ...
      criteria_refs,collaborating_department_ids,collaborating_user_ids
    )
    values(
      ...
      v_criteria_refs,v_collaborating_department_ids,v_collaborating_user_ids
    )
...
revoke all on function public.qlcl_approve_plan_bundle_v5(uuid,uuid) from public, anon, authenticated;
grant execute on function public.qlcl_approve_plan_bundle_v5(uuid,uuid) to service_role;
