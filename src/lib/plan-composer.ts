...
export function validatePlanAutomationOutput(output: PlanAutomationOutput, dueDate: string | null) {
...
export function validatePlanDraftAction(action: PlanDraftAction, planStart: string | null, planEnd: string | null) {
  ...
  for (const output of action.automation_outputs) {
    const outputError = validatePlanAutomationOutput(output, action.due_date);
