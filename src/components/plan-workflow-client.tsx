...
export function PlanWorkflowClient({
  ...
  return <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 8, flexWrap: "wrap" }}>{message ? <span className="tiny" style={{ color: "#b42318" }}>{message}</span> : null}{controls}</div>;
}
