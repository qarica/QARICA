      ...
      <div className="modal-body" style={{ flex: "1 1 auto", minHeight: 0, overflowY: "auto", padding: "24px 28px 30px" }}>
        ...
        <div className="form-stack" style={{ gap: 24 }}>
          <section><div style={{ marginBottom: 13 }}><strong style={{ fontSize: 14 }}>1. Thông tin kế hoạch</strong><div className="muted tiny" style={{ marginTop: 4 }}>Tên, loại, đơn vị chủ trì và đầu mối.</div></div><div className="form-grid two" style={{ gap: 16 }}>
            ...
            <label className="span-2"><span>Nhóm thực hiện</span><MultiCheckSelect options={workGroupOptions} value={form.assignedGroupIds} onChange={(ids) => setForm({ ...form, assignedGroupIds: ids })} placeholder="Chọn nhóm đã cấu hình" emptyText="Chưa có nhóm được cấu hình. Quản trị viên tạo tại Quản trị hệ thống → Nhóm phân công." /></label>
          </div></section>
          ...
          <div className="scope-note"><strong>Cấu hình dùng lại:</strong> căn cứ lấy từ <strong>Văn bản / Chỉ đạo</strong>; nhóm thực hiện lấy từ <strong>Quản trị hệ thống → Nhóm phân công</strong>. Chỉ khai báo một lần và tái sử dụng cho nhiều kế hoạch.</div>
