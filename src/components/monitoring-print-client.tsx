...
export function MonitoringPrintClient({ isConfirmed = false }: { isConfirmed?: boolean }) {
  ...
  return <button type="button" className="button primary no-print" onClick={printRecord}>
