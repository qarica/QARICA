  ...
  return (
    <section className="tqm-scorecard panel">
      <style>{`
        ...
        .tqm-scorecard-row:hover{border-color:#9bcfc8;background:#fbfefe;transform:translateY(-1px)}
        ...
        .tqm-scorecard-status{font-size:9px!important;font-weight:800;color:#17645f!important;background:#edf8f6;border-radius:999px;padding:5px 7px;margin:0!important;white-space:nowrap}
