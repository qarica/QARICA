...
export function RiskWorkflowClient({
  ...
  return <section className="panel risk-workflow-panel">
    ...
    `}</style>
    <div className="risk-wf-head"><div><h2>Risk Register · Vòng xử lý rủi ro</h2><p>Điểm rủi ro lấy từ Risk Matrix đã phát hành; sau xử lý phải đánh giá residual risk trước khi chấp nhận hoặc tiếp tục theo dõi.</p></div><StatusBadge status={status} label={STATUS_LABEL[status]||status} /></div>
