  ...
  return (
    <section className="tqm-process-map panel">
      <style>{`
        ...
        .tqm-process-step:hover{transform:translateY(-2px);border-color:#e3b8c3;box-shadow:0 8px 18px rgba(16,40,72,.08)}
        ...
        .tqm-process-dot{width:10px;height:10px;border-radius:50%;margin-bottom:11px;background:#7a2740}
