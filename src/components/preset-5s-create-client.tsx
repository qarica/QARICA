...
export function Preset5SCreateClient({ departments, canManage }: { departments: Department[]; canManage: boolean }) {
  ...
  return <section className="panel preset5s-card">
    <style>{`
      ...
      .preset5s-icon{width:44px;height:44px;border-radius:13px;background:#e6fbf8;color:#0d9488;display:flex;align-items:center;justify-content:center;flex:0 0 auto;border:1px solid #d7e1ed}
