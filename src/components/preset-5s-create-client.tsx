...
export function Preset5SCreateClient({ departments, canManage }: { departments: Department[]; canManage: boolean }) {
  ...
  return <section className="panel preset5s-card">
    <style>{`
      ...
      .preset5s-icon{width:44px;height:44px;border-radius:13px;background:#e8f6f3;color:#0f766e;display:flex;align-items:center;justify-content:center;flex:0 0 auto;border:1px solid #d5ebe7}
