  ...
  return <div className="page-stack modern-module-page domain-record-page">
    ...
    {isPriorityWorkflow ? <>
      ...
      {isIncident ? <div className="priority-record-stack">
        ...
        {incidentAtActions ? <div id="incident-actions" style={{display:"grid",gap:12,scrollMarginTop:90}}><RecordActionsPanel recordId={record.id} recordType={record.record_type} sourceTitle={`${record.record_code} · ${record.title}`} /><IncidentCapaLinkClient recordId={record.id} /></div> : null}
