  ...
  return (
    <section className="panel plan-composer" style={{ padding: 18, display: "flex", flexDirection: "column", gap: 16 }}>
      <style>{`
        ...
        .plan-composer .task-card{position:relative;padding:16px;background:#f7fbfc;border:2px solid #7898a8;border-radius:14px;box-shadow:0 3px 10px rgba(31,55,70,.10)}\n        .plan-composer .task-card input:not([type="checkbox"]),.plan-composer .task-card select,.plan-composer .task-card textarea{background:#fff;border:2px solid #8aa7b5!important;border-radius:9px!important;box-shadow:inset 0 0 0 1px rgba(255,255,255,.8)}\n        .plan-composer .task-card input:not([type="checkbox"]):hover,.plan-composer .task-card select:hover,.plan-composer .task-card textarea:hover{border-color:#607f8f!important}\n        .plan-composer .task-card input:not([type="checkbox"]):focus,.plan-composer .task-card select:focus,.plan-composer .task-card textarea:focus{border-color:#0d9488!important;box-shadow:0 0 0 3px rgba(13,148,136,.16)!important;outline:none}
