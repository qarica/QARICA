  ...
  return (
    <section className="tqm-smart-center">
      <style>{`
        ...
        .tqm-smart-ring{width:94px;height:94px;border-radius:50%;display:grid;place-items:center;background:conic-gradient(#7a2740 calc(var(--score)*1%),#e8efef 0);position:relative}
        ...
        .tqm-smart-priority{background:linear-gradient(135deg,#33101a,#7a2740);color:white;border-color:transparent}
        ...
        .tqm-mini-track span{display:block;height:100%;border-radius:inherit;background:#7a2740}
