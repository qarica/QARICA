...
export default async function PlansPage() {
  ...
  const [programsRes, recordsRes, progressRes, departmentsRes, profilesRes] = await Promise.all([
  ...
  return <div className="page-stack plans-page tqm-workspace">
    ...
    <PlansClient year={year} canManage={user.permissions.includes("plans.manage")} rows={rows} departments={(departmentsRes.data ?? []) as any[]} profiles={(profilesRes.data ?? []) as any[]} />
  </div>;
}
