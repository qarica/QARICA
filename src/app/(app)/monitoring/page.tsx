...
export default async function MonitoringPage() {
  ...
  const [templatesRes, versionsRes, sectionsRes, itemsRes, roundsRes, departmentsRes] = await Promise.all([
    ...
    supabase.from("monitoring_rounds").select("id,record_id,checklist_version_id,work_year,scheduled_date,target_department_id,target_area,workflow_status,started_at,completed_at").eq("work_year", year).neq("workflow_status", "CANCELLED").order("scheduled_date", { ascending: false, nullsFirst: false }),
