  ...
  return <div className="page-stack monitoring-round-page">
    <style>{`
      ...
      @media(max-width:760px){
        ...
        .monitoring-result-card-head{display:flex;justify-content:space-between;gap:10px;align-items:flex-start}.monitoring-result-card-head strong{color:#0f766e;font-size:13px}
